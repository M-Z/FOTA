...
int main(int argc, char *argv[]) {
  ...
  DMA_Config newDMA = {
      ...
      BITS_8, // Specifies Destination data size alignment (byte, half word,
              // word).
      ...
      FROM_PERIPHRAL, // If the data will be transferred from memory to
                      // peripheral: FROM_MEM, FROM_PERIPHRAL
