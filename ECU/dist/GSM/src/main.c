...
int	main(int argc, char* argv[])
{
	...
	//bank 1 c13
	GSM_enuPOSTRequestInit("34.65.7.33/API/firmware/v/5e94a4732bc8d903083076bc", "{\"vehicleName\":\"fota user\",\"password\":\"123\"}\r\n", responseData, &u32filesize);
	//bank 2 c14
//	GSM_enuPOSTRequestInit("34.65.7.33/API/firmware/v/5e94a9652bc8d903083076be", "{\"vehicleName\":\"fota user\",\"password\":\"123\"}\r\n", responseData, &u32filesize);
