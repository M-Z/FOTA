    ...
    * self.stream
    ...
    def consumeEntity(self, allowedChar=None, fromAttribute=False):
        ...
        if (charStack[0] in spaceCharacters or charStack[0] in (EOF, "<", "&")
            ...
            try:
                entityName = entitiesTrie.longest_prefix("".join(
                    charStack[:-1]))
            ...
            if entityName is not None:
                if entityName[-1] != ";":
                    self.tokenQueue.append({
                        "type":
                        tokenTypes["ParseError"],
                        "data":
                        "named-entity-without-semicolon",
                    })
                if (entityName[-1] != ";" and fromAttribute
                        and (charStack[entityLength] in asciiLetters
    ...
    def rcdataEndTagNameState(self):
        appropriate = (
            ...
            self.currentToken["name"].lower() == self.temporaryBuffer.lower())
        data = self.stream.char()
    ...
    def markupDeclarationOpenState(self):
        ...
        if charStack[-1] == "-":
            ...
            if matched:
                ...
                return True
        elif (charStack[-1] == "[" and self.parser is not None
