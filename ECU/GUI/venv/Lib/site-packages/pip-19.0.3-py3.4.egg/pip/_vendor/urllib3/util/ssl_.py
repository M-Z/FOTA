...
def create_urllib3_context(ssl_version=None,
    ...
    if (getattr(context, "check_hostname", None) is
            not None):  # Platform-specific: Python 3.2
...
def ssl_wrap_socket(
    ...
    if context is None:
        ...
        # this code.
        context = create_urllib3_context(ssl_version,
                                         cert_reqs,
                                         ciphers=ciphers)
    ...
    if (server_hostname is not None
            and not is_ipaddress(server_hostname)) or IS_SECURETRANSPORT:
