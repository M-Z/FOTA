...
from .utils import parse_rfc3339_re
from .utils import rfc3339_re
...
def loads(s,
    ...
    for kind, value, pos in ast:
        if kind == "kv":
            k, v = value
            if k in scope:
                error('duplicate_keys. Key "{0}" was used more than once.'.
                      format(k))
