...
class _BaseNetwork(_IPAddressBase):
    ...
    def __contains__(self, other):
        ...
        # dealing with another address
            ...
            # address
            return (int(self.network_address) <= int(other._ip) <= int(
...
class _BaseV4(object):
    ...
    def _ip_int_from_string(cls, ip_str):
        ...
        try:
            return _compat_int_from_byte_vals(map(cls._parse_octet, octets),
                                              "big")
...
class IPv4Interface(IPv4Address):
    ...
    def __str__(self):
        return "%s/%d" % (self._string_from_ip_int(
            self._ip), self.network.prefixlen)
