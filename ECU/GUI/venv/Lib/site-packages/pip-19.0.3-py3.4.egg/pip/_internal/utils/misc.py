...
from pip._internal.locations import (running_under_virtualenv, site_packages,
                                     user_site, virtualenv_no_global,
                                     write_delete_marker_file)
from pip._internal.utils.compat import (WINDOWS, console_to_str, expanduser,
                                        stdlib_pkgs)
...
if MYPY_CHECK_RUNNING:
    from typing import (Any, AnyStr, Container, Iterable, List,  # noqa: F401
                        Mapping, Match, Optional, Text, Tuple, Union)
