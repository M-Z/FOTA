...
from pip._internal.locations import PIP_DELETE_MARKER_FILENAME
...
def message_about_scripts_not_on_PATH(scripts):
    ...
    for parent_dir, scripts in warn_for.items():
        ...
        if len(scripts) == 1:
            ...
            start_text = "scripts {} are".format(", ".join(scripts[:-1]) +
                                                 " and " + scripts[-1])
...
class Wheel(object):
    ...
    def __init__(self, filename):
        ...
        if not wheel_info:
            raise InvalidWheelFilename("%s is not a valid wheel filename." %
                                       filename)
        ...
        self.file_tags = {(x, y, z)
                          for x in self.pyversions for y in self.abis
                          for z in self.plats}
...
class WheelBuilder(object):
    ...
    def _build_one(self, req, output_dir, python_tag=None):
        ...
        with req.build_env:
            return self._build_one_inside_env(req,
                                              output_dir,
    ...
    def _base_setup_args(self, req):
        ...
        # virtualenv.
        return [sys.executable, "-u", "-c", SETUPTOOLS_SHIM % req.setup_py
