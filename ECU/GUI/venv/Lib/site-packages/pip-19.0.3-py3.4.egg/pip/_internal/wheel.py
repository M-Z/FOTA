...
from pip._internal.utils.misc import (call_subprocess, captured_stdout,
                                      ensure_dir, read_chunks)
...
if MYPY_CHECK_RUNNING:
    from typing import (IO, Any, Dict, Iterable, List, Mapping,  # noqa: F401
