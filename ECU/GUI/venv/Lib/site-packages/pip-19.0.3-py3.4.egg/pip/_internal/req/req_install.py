...
class InstallRequirement(object):
            ...
            if self.editable:
                ...
                for root, dirs, files in os.walk(base):
                    ...
                    for dir in list(dirs):
                        ...
                        # environment
                        if os.path.lexists(
                                os.path.join(root, dir, "bin",
                                             "python")) or os.path.exists(
                                                 os.path.join(
                                                     root, dir, "Scripts",
                                                     "Python.exe")):
                            dirs.remove(dir)
    ...
    def get_dist(self):
        ...
        if self.metadata_directory:
            ...
            metadata = pkg_resources.PathMetadata(base_dir,
    ...
    def _clean_zip_name(self, name, prefix):  # only used by archive.
        assert name.startswith(
            prefix +
            os.path.sep), "name %r doesn't start with prefix %r" % (name,
                                                                    prefix)
