...
from pip._internal.download import is_archive_file
...
def parse_editable(editable_req):
    ...
    if not vcs.get_backend(vc_type):
        error_message = ("For --editable=%s only " % editable_req + ", ".join(
            [backend.name + "+URL"
             for backend in vcs.backends]) + " is currently supported")
