...
///////////******************USART3**********************///////////////
#define USART3_NoRemap                                                         \
  0x00000000 //(TX/PB10, RX/PB11, CK/PB12, CTS/PB13, RTS/PB14)
#define USART3_PartialRemap                                                    \
  0x00000001 //(TX/PC10, RX/PC11, CK/PC12, CTS/PB13, RTS/PB14)
#define USART3_FullRemap                                                       \
  0x00000003 //(TX/PD8, RX/PD9, CK/PD10, CTS/PD11, RTS/PD12)

///////////******************TIM1**********************///////////////

#define TIM1_NoRemap                                                           \
  0x00000000 //(ETR/PA12, CH1/PA8, CH2/PA9, CH3/PA10, CH4/PA11, BKIN/PB12,
// CH1N/PB13, CH2N/PB14, CH3N/PB15)
#define TIM1_PartialRemap                                                      \
  0x00000001 //(ETR/PA12, CH1/PA8, CH2/PA9, CH3/PA10, CH4/PA11, BKIN/PA6,
// CH1N/PA7, CH2N/PB0, CH3N/PB1)
#define TIM1_FullRemap                                                         \
  0x00000003 //(ETR/PE7, CH1/PE9, CH2/PE11, CH3/PE13, CH4/PE14, BKIN/PE15,
// CH1N/PE8, CH2N/PE10, CH3N/PE12)

///////////******************TIM2**********************///////////////

#define TIM2_NoRemap 0x00000000 //(CH1/ETR/PA0, CH2/PA1, CH3/PA2, CH4/PA3)
#define TIM2_PartialRemap_1                                                    \
  0x00000001 //(CH1/ETR/PA15, CH2/PB3, CH3/PA2, CH4/PA3)
#define TIM2_PartialRemap_2                                                    \
  0x00000002                      //(CH1/ETR/PA0, CH2/PA1, CH3/PB10, CH4/PB11)
...
#define TIM4_NoRemap                                                           \
  0x00000000 //(TIM4_CH1/PB6, TIM4_CH2/PB7, TIM4_CH3/PB8, TIM4_CH4/PB9)
#define TIM4_FullRemap                                                         \
  0x00000001 //(TIM4_CH1/PD12, TIM4_CH2/PD13, TIM4_CH3/PD14, TIM4_CH4/PD15)

///////////******************CAN1**********************///////////////

#define CAN_TX_A12_RX_A11                                                      \
  0x00000000 // CAN1_RX mapped to PA11, CAN1_TX mapped to PA12
#define CAN_TX_B9_RX_B8                                                        \
  0x00000002 // CAN1_RX mapped to PB8, CAN1_TX mapped to PB9
#define CAN_TX_D1_RX_D0                                                        \
  0x00000003 // CAN1_RX mapped to PD0, CAN1_TX mapped to PD1
...
//#define   SW-DP_N0_JTAG-DP							0x00000002
////JTAG-DP Disabled and SW-DP Enabled #define   JTAG-DP_N0_SW-DP
//0x00000004		//JTAG-DP Disabled and SW-DP Disabled
